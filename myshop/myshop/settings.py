...
SECRET_KEY = 'django-insecure-wf5bs8$@t4uuuqnn)(0kcv$+0x#2y6u=*r@i*4lno+o53nv%mx'
...
# Es pecificamos los directoreios donde Django debe buscar los archivos de traducciòn.
LOCALE_PATHS = [
    BASE_DIR / 'locale',
]
